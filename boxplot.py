...
ax1.boxplot([retention0,retention1,retention2,retention3,retention4,retention5,retention6,retention7,retention8,retention9],labels=['0.00','0.05','0.10','0.15','0.20','0.25','0.30','0.35','0.40','0.45'])
for i in range (0,9):
    plt.text(i+0.75,np.max(globals()['retention{}'.format(i)])+0.5,'{:.1f}'.format(np.max(globals()['retention{}'.format(i)])))
    plt.text(i+0.75,np.min(globals()['retention{}'.format(i)])-3.5,'{:.1f}'.format(np.min(globals()['retention{}'.format(i)])))
    ...
    plt.text(i+1.05,globals()['no_retention{}'.format(i)]-1.1,'{:.1f}'.format(globals()['no_retention{}'.format(i)]))
plt.text(9.75,np.max(globals()['retention{}'.format(9)])+0.5,'{:.1f}'.format(np.max(globals()['retention{}'.format(9)])))
plt.text(9.75,np.min(globals()['retention{}'.format(9)])-3.5,'{:.1f}'.format(np.min(globals()['retention{}'.format(9)])))
...
plt.text(10.05,globals()['no_retention{}'.format(9)]-1.1,'{:.1f}'.format(globals()['no_retention{}'.format(9)]))
